...
def stories():
    ...
    # st.markdown("Bowmer is an anomaly. He defies every logical explanation that the sport of football could provide. He is a singular, nightmarish row in the data that has as much significance as it has first name. But, in a way, Bowmer is a light for all of us. He shows that no matter how hard you try to be forgotten, someone will remember. No matter how unremarkable you are, your legacy will live on long after you are gone. To me, Bowmer is neither a joke nor a failure; he is hope. Appearing in this football game could have been his life’s goal, and thus he represents the manifestation of dreams, even when reality knocks you down for a 19 yard loss. Bowmer is a painful exemplification of the human spirit, and what could be more remarkable than that?")
    # st.markdown("For all this, he has been affectionately and deservedly nicknamed “My Main Man Bowmer” in the data. ")
    
    st.markdown("When looking at the full list of games, individual performances start to seem insignificant, but underneath the numbers lie stories. Every single statistic represents a real person that deserves to be remembered. I want to tell two of those stories here.")
    st.markdown("On October 2nd, 1954, Texas beat Washington State in a game that almost never happened. Texas had an unofficial rule that disallowed black players from playing at Memorial Stadium (now called Darrell K Royal–Texas Memorial Stadium). Washington State refused to travel without their star back Duke Washington, going as far as saying “no Washington, no game.” Eventually, the Longhorns caved. Even though he could not stay in the hotel with the other players, he got a standing ovation from the enemy crowd on his 73 yard touchdown run in the second quarter. Though Texas themselves would not field a black player until 1970, this game marked a significant turning point in the program’s history. Washington’s triumphant performance was all anyone could talk about after the game, even receiving praise in the New York Times. His story is one of accomplishment and valor, so obviously worthy of commemoration that opposing fans cheered for his achievement. He will never be forgotten.")
    st.markdown("The news about Washington dwarfed any other storylines from the game, but that does not mean there weren’t more stories to tell. If you look closely, there is another player buried in the box score, easy to miss if you don’t know what you’re looking for. His name is Bowmer, and he has no first name.")
    st.markdown("From what I can tell, Bowmer had the most insignificant career in college football history. On this random Saturday in 1954, Bowmer recorded three stats. He punted the ball once for 38 yards, he returned a kickoff for 14 yards, and he carried the ball twice for an unbelievable -19 yards. It is unexplainable to me how one would accrue this collection of stats. Even more interesting, this was the only game he ever appeared in. In fact, I couldn’t even find evidence of his existence outside of this football game. The only thing left of Bowmer’s legacy is a single point in this data set.")
    st.markdown("Bowmer is an anomaly. He defies every logical explanation that the sport of football could provide. He is a singular, nightmarish row in the data that has as much significance as it has first name. But, in a way, Bowmer is a light for all of us. He shows that no matter how hard you try to be forgotten, someone will remember. No matter how unremarkable you are, your legacy will live on long after you are gone. To me, Bowmer is neither a joke nor a failure; he is hope. Appearing in this football game could have been his life’s goal, and thus he represents the manifestation of dreams, even when reality knocks you down for a 19 yard loss. Bowmer is a painful exemplification of the human spirit, and what could be more remarkable than that?")
    st.markdown("For all this, he has been affectionately and deservedly nicknamed “My Main Man Bowmer” in the data.")
